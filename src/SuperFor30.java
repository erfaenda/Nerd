...
public class SuperFor30 {
    public static void main(String[] args) {
        int Beer[] = {1, 2, 3, 8, 6}; //каждый элемент массива - это колличество кружек выпитого пива
        int sum = 0; //изначально пустая переменная суммы кружек пива
        ...
        for (int i:Beer){ //Продвинутый цикл ФОР ему нужно только два парамета. при первом прогоне первый элемент массива и далее он увеличиваеться на 1
            sum += i; //сумма первого элемента равняесться сумме второго
        }
